...
import com.winiciussturm.cursomc.domain.PagamentoComCartao;
...
import com.winiciussturm.cursomc.repositories.CidadeRepository;
...
import com.winiciussturm.cursomc.repositories.EstadoRepository;
...
public class DBService 
{
	...
	public void instantiateTestDatabase () throws ParseException
	{
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));//Arrays.aslist cria uma lista com vários elementos a serem gravados no banco de dados
		...
		Cliente cli1 = new Cliente(null, "Maria da Silva", "winicius-sturn@educar.rs.gov.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "winiciussturm@gmail.com", "05044406082", TipoCliente.PESSOAFISICA, pe.encode("123"));
