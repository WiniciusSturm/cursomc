...
import com.winiciussturm.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler //Manipulador de erros
{
	...
	public ResponseEntity<StandardError> file (FileException e, HttpServletRequest request) //Padrão do Controller Advice
	{
	...
	public ResponseEntity<StandardError> amazonService (AmazonServiceException e, HttpServletRequest request) //Padrão do Controller Advice
	{
	...
	public ResponseEntity<StandardError> amazonClient (AmazonClientException e, HttpServletRequest request) //Padrão do Controller Advice
	{
	...
	public ResponseEntity<StandardError> amazonS3 (AmazonS3Exception e, HttpServletRequest request) //Padrão do Controller Advice
	{
